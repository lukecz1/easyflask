...
# Configure the app based on environment variables
        ...
        for result in results:
            ...
            for box in result.boxes:
                ...
                if source_type == 'webcam':
                    ...
                    font_scale = max(5, min(2.0, (x2 - x1) / 100))  # File upload adjustment
                    font_thickness = max(5, min(3, int(font_scale)))  # File upload adjustment
